---
title: "Cycling the Big Apple"
date: 2025-09-24T19:40:41-07:00
description: "Biking in New York City may be intimidating, but with Rapha and a few helpful pointers I learned from my recent trip there, you too can enjoy riding around the Big Apple."
image: "hunters_point"
categories: [
  "New York City",
]
tags: ["New York City", "Rapha", "Bike Rental"]
keywords: [
  "Biking in New York City",
  "NYC bike ride",
  "Cycling in NYC",
  "Rapha bike rental hire",
  "NYC bike routes",
]
draft: false
resources:
- src: '*/hunters_point.jpg'
  name: "hunters_point"
  title: "Such a beautiful spot just across the water from Manhattan"
  params:
    alt: "Factor Monza David Carson edition bicycle rented from Rapha New York with view of Manhattan, New York City."
- src: '*/david_carson_monza.jpg'
  name: "david_carson_monza"
  title: "So beautiful"
  params:
    alt: "Factor Monza David Carons edition bicycle on display at the Rapha clubhouse in New York City."
- src: '*/bikepath.jpg'
  name: "bikepath"
  title: "So many people out on the paths, you could just wait a minute to see more groups of riders"
  params:
    alt: "Bicycle riders riding along a bike path in East Manhattan, New York City."
    width: 50
- src: '*/queensboro_bikepath.jpg'
  name: "queensboro_bikepath"
  title: "Seriously, so many people out!"
  params:
    alt: "Bicycle riders riding on the east descent along the Queensboro bridge bike path in New York City"
    width: 50
- src: '*/times_far.jpg'
  name: "times_far"
  title: "I'm glad I got this picture, no way was I able to stop mid-ride through Times Square that night!"
  params:
    alt: "Delivery bicycle rider traveling through an intersection on 7th Ave in New York City on their way to Times Square"
    width: 50
- src: '*/times.jpg'
  name: "times"
  title: "I was told by a few people that it wasn't even busy that night"
  params:
    alt: "Masses of people and cars in Times Square at night"
- src: '*/coffeeshop.jpg'
  name: "coffeeshop"
  title: "There were almost 100 bikes parked out front that day!"
  params:
    alt: "Factor Monza bicycle parked outside the Coffee Ride Cafe in Nyack, New Jersey"
    width: 50
- src: '*/group_nyack.jpg'
  name: "group_nyack"
  title: "All smiles that day!"
  params:
    alt: "Group photo of cyclists mid ride at the Coffee Ride Cafe in Nyack, New Jersey."
- src: '*/jersey.jpg'
  name: "jersey"
  title: "I always love shots like this, mid-moment"
  params:
    alt: "Cyclists riding along a tree lined road in New Jersey"
    width: 50
- src: '*/brownstone.jpg'
  name: "brownstone"
  title: "There are quite a few of these through the city, but you sometimes have to stop to notice them when riding through."
  params:
    alt: "Brownstone building near Brookly, NYC"
    width: 50
- src: '*/brooklyn_bridge.jpg'
  name: "brooklyn_bridge"
  title: "I really liked this park"
  params:
    alt: "Bicycle with the Brooklyn Bridge in the background from Jane's Carousel near DUMBO in Brooklyn, NYC."
    width: 50
- src: '*/manhattan_bridge.jpg'
  name: "manhattan_bridge"
  title: "THE iconic shot, you wouldn't believe how many people were there doing the same thing that day!"
  params:
    alt: "Iconic view of the Manhattan Bridge with the Empire State Building peeking through the bottom."
    width: 50
- src: '*/graffiti.jpg'
  name: "graffiti"
  title: "I thought this was so visually interesting, and was just kind of in the middle of nowhere."
  params:
    alt: "Factor Monza bicycle in front of an old train car covered in graffiti near Red Hook in Brooklyn, NY."
- src: '*/zoo.jpg'
  name: "zoo"
  title: "Only animal there that day was me"
  params:
    alt: "Factor Monza bicycle parked in front of the gates at Central Park Zoo."
- src: '*/sailboat.jpg'
  name: "sailboat"
  title: "It was shockingly windy that day, so that sailboat was in quite a ride!"
  params:
    alt: "Sailboat in New York Harbor with the Verrazano–Narrows Bridge in the background"
- src: '*/coney.jpg'
  name: "coney"
  title: "There were a lot of dudes who looked like this guy at Coney Island"
  params:
    alt: "View over the boardwalk at Coney Island, NY."
---
# "If you can make it here, you can make it anywhere!"
When most people think about New York City, I don't think "ride your bike" is one of them. But that doesn't mean it is a bad place to ride your bike. It's actually kind of _awesome_.
...
{{< img 2 bikepath queensboro_bikepath >}}
...
I felt initially quite apprehensive about riding in NYC, since "[the yellow ones don't stop](https://clip.cafe/elf-2003/its-at-the-beginning-end-of-war-that-have-watch-out-s2/)" and there are pedestrians, bikes, cars, and noise _everywhere_. 
...
It's funny how that works. In the big city, people get used to a certain rhythm, and they have their own "code" or rules that you see when it comes to navigating the busy sidewalks. It translates to how they drive and how they ride. Surprisingly, I found it easy to pick up on and I also found myself becoming annoyed at "all the damn tourists" when navigating the more particularly touristy spots like [Times Square](https://maps.app.goo.gl/TwVvz4dFhWMbiQie6) or the [Financial District](https://maps.app.goo.gl/mjqthafX7jSBQETP9).

## A Few Highlights
While the conference was amazing, the bagels were "chewy" enough, and getting stuck inside a stairwell at the Empire State Building was mildly terrifying, I want to stay on topic. I mean, this is a _bike_ blog after all!

### "Blinded by the Light" of Times Square
One of the experiences I won't ever forgot was at dusk during the last part of my first day of riding where I found myself riding down 7th back to my hotel. Little did I realize that it would take me straight through the _heart_ of Times Square with approximately a billion other people.

I followed a few food delivery cyclists (a common thing there) and began to take courage and, dare I say, _enjoyment_ in pacing them a bit. With so many people lining the sidewalks and spilling out over into the bike lanes, I actually felt far safer being in the middle of the road, taking the lane in one of the busiest streets in one of the busiest cities _in the world_. Lit up by the massive LED advertisements of Times Square, it truly was _an experience_, one that I'm so glad I had.

{{< img 2 times_far times >}}
...
I definitely want to shout out to the folks running the [Rapha shop](https://maps.app.goo.gl/gP8pUE43LRWfZNLbA) in NYC!
...
Let's also not forget to mention that my bike rental from Rapha was truly spectacular - a brand new [David Carson edition of the Factor Monza](https://factorbikes.com/bikes/monza-rcc-david-carson-edition-2025) that had _literally just come out_. I was actually the first one to rent this bike, as previously the only riders on it were for photo / demo purposes to showcase the uniqueness of this particular frame.

{{< img david_carson_monza >}}
...
From there, we spent the majority of the day riding together, chatting and discussing what life is like out there, what people do for work and for fun, that sort of thing. The ride took us north through New Jersey, following the Hudson river, up to a [Coffee Ride Cafe](https://maps.app.goo.gl/E2bs8g7cabAKcU589) in Nyack. This coffee shop had probably _the_ most bikes I've even seen occupy the outside of a coffee shop anywhere I've ever been. Pretty crazy.

{{< img 2 coffeeshop jersey >}}

Along the way I got to know a new friend who is, curiously enough, moving to Orange County soon. [My old neck of the woods]({{< ref "/blog/Introspective/My_Story/index.md" >}})! I always love finding commonality with people in new and interesting places - it's something that helps you realize that in today's modern society, the world isn't so big and divided as we all think it is.

{{< img group_nyack >}}

### Lapping Central Park and Prospect Park
...
Sadly enough, I don't have many pictures of these from when I rode through them both, but let me just say this about them both - they're hilariously fun to ride on a bike! And if you stop for a bit, you can even see the famous [Central Park Zoo](https://maps.app.goo.gl/yi2bTi97asQnNRJz7).

{{< img zoo >}}

You ride counter-clockwise through both parks, and you can legitimately bike them without stopping. And as many times as you want. Central Park is of course far more crowded, but if you ride it during the magic 7-8pm hour in the summer (as I did), you won't see any cars, nor will you see too many pedestrians. It'll just be you and hundreds (yes, _hundreds_) of other riders! It was like riding a formal, organized event in a way. The few pedestrians I saw looked out of place and seemed far more terrified of us than we were of them.
...
### Bridges, Bike Lanes, and...Coney Island?
Oh, the bridges of New York City. I find them so fascinating because, while we have one _really_ iconic one here in the Bay Area, NYC has _several_.

Most of the popular ones connect the island of Manhattan to the other burroughs of NYC, most notably Brooklyn, where a lot of people choose to live and has its own vibe. A lot of [brownstone housing](https://en.wikipedia.org/wiki/Brownstone) and slightly more of a suburb compared to Manhattan. I was impressed by how well connected all the bike paths are through there, and just how seamless it is to ride through to each of them - assuming you know where you're going of course!

{{< img brownstone >}}

Each bridge has its own "style" to it, some wider than others, each with varying degrees of how approachable its entrances are. I personally liked the [Queensboro bridge](https://maps.app.goo.gl/x3oSihFUbu8LEgNe7) the most, but the eastern approach (going west) of the [Brooklyn Bridge](https://maps.app.goo.gl/Rzm9KHUBKoVtSfT99) was spectacular, too, because of the iconic view of the bridge itself while riding towards its pillars. 
...
{{< img 2 brooklyn_bridge manhattan_bridge >}}
...
{{< img 2 sailboat coney >}}

# The Routes
I chose to not put these first (like I normally do) because I was hoping to convey a certain _vibe_ or _feeling_ I had from this trip. 

Since New York isn't exactly the first on cyclist's mind when it comes to riding, I found myself pleasantly surprised at how well it all just _works_ together. I've recently become quite interested in city infrastructure design and transforming any American city is a task unto itself these days.
...
## Day One: A Tour of the Big Apple
...
## Day Two: A Typical Summer Weekend in New Jersey
Starting from my hotel in Midtown Manhattan, I rode up to Central Park to meet a few Rapha folks, taking a half loop through Central Park. On that particular day, there was an official 10k run going on, done in preparation for the more formal [NYC Marathon](https://www.nyrr.org/tcsnycmarathon). The energy was palpable that morning, and we spent time dodging a few runners and a couple others who chose to swim upstream to the pack.

They took me up past Harlem Hill and over the [George Washington Bridge](https://maps.app.goo.gl/DGdJxL7FNTemro2Y6) into New Jersey where we met at [Strictly Bicycles](https://www.strictlybicycles.com/), where we were joined by several other riders. It was from there where we rode all the way up to [Nyack](https://maps.app.goo.gl/FmS5Naq4fdS13U8f7), a very quaint, Americana town with a fabulous coffee shop and beautiful views over the Hudson river.

{{< strava id=15561964120 >}}
...
## Day Three: A Windy Ride to Coney Island
