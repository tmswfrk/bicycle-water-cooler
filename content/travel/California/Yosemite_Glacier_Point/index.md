...
image: Yosemite_Valley_Tunnel_View_Afternoon
imagealt: 
...
draft: false
resources:
- src: '*/Yosemite_Valley_Tunnel_View_Afternoon.jpeg'
  name: "Yosemite_Valley_Tunnel_View_Afternoon"
  title: ""
  params:
    alt: "An early season bucket list ride to Glacier Point in Yosemite, California. Let me tell you how it went!"
- src: '*/Yosemite_Falls.jpg'
  name: "yosemite_falls"
  title: "This picture does NOT do it justice!"
  params:
    alt: "Yosemite Falls viewed from near Yosemite Lodge in Yosemite Valley, California.
    width: 75"
- src: '*/el_capitan.jpg'
  name: "el_capitan"
  title: "Incredible to think people climb this!"
  params:
    alt: "Front side view of El Capitan in Yosemite Valley, California, taken from the Yosemite Valley Loop road."
    width: 75
- src: '*/Yosemite_Valley_Tunnel_View_Morning.jpg'
  name: "morning_view"
  title: "It looks like a painting, you just can't grasp its magnificence without physically being there!"
  params:
    alt: "Bikes parked out at Tunnel View near the entrance to Yosemite Valley."
- src: '*/tunnel_entrance.jpg'
  name: "tunnel_entrance"
  title: "It's quite a large tunnel!"
  params:
    alt: "Cyclist near the entrance of the Yosemite National Park Tunnel."
- src: '*/Glacier_Point_Sign.jpg'
  name: "glacier_point_sign"
  title: "Here we go!"
  params:
    alt: "Cyclist by the Glacier Point turnoff road sign in Yosemite National Park."
- src: '*/Washburn_Point.jpg'
  name: "washburn_point"
  title: "Looking out over Half Dome in this way really is a fun way to see it."
  params:
    alt: "Bikes along the wall at Washburn Point in Yosemite National Park with views of Half Dome, Vernal Falls, and Nevada Falls."
- src: '*/NPS_Half_Dome_Cables.jpg'
  name: "half_dome_cables"
  title: "Care of the National Park Service website."
  params:
    alt: "National Park Service picture of the Half Dome cables, as seen from below."
    width: 20
- src: '*/Glacier_Point_Curve_Vista.jpg'
  name: "glacier_point_vista"
  title: "We both immediately stopped, as this just came up out of nowhere!"
  params:
    alt: "View out over Half Dome from Glacier Point"
- src: '*/Glacier_Point_Vista_Switchback.jpg'
  name: "switchback"
  title: "The road is basically perfect through here, too."
  params:
    alt: "Switchback road section at Glacier Point Curve Vista in Yosemite National Park."
- src: '*/Glacier_Point_bike.jpg'
  name: "glacier_point_bike"
  title: "There are typically a lot of people up there, as it's a popular destination to drive to."
  params:
    alt: "Factor O2 VAM bike resting in bushes at Glacier Point in Yosemite National Park with view out over Half Dome."
- src: '*/Four_Mile_Trail_Sign.jpg'
  name: "trail_sign"
  title: "Four Mile Trail looks like a beast of a hike!"
  params:
    alt: "Sign at Glacier Point directing visitors to Four Mile Trail and Glacier Point"
    width: 50
- src: '*/bikes_tunnel_view_afternoon.jpg'
  name: "tunnel_view_afternoon"
  title: "We didn't want to leave!"
  params:
    alt: "Factor O2 VAM and Cannondale Synapse bikes at Tunnel View overlooking Yosemite Valley in Yosemite National Park."
- src: '*/couple_shot_tunnel_view.jpg'
  name: "couple_tunnel_view"
  title: "Hashtag couple goals!"
  params:
    alt: "Cyclist couple selfie shot at Tunnel View in Yosemite Valley, Yosemite National Park, California"
- src: ''
  name: ""
  title: ""
  params:
...
{{< yt title="Glacier Point turnoff to Avalanche creek" id="WzcL0j_46DA" alt="Point of view video of a cycling descent from the Glacier Point road turnoff to Avalanche Creek along Wawona Road." >}}
{{< yt title="Yosemite Tunnel View Descent" id="y8lceR05Ido" alt="Point of view video of a cycling descent along Wawona Road in Yosemite National Park through the tunnel to Tunnel View" >}}

Definitely make sure to stop again at Tunnel View once you're there. It's magical at all times of the day!

{{< img tunnel_view_afternoon >}}
...
{{< yt title="Descent from Tunnel View to Yosemite Valley" id="oViyydUJfRQ" alt="Point of view video of a cycling descent from Tunnel View in Yosemite National Park to Yosemite Valley" >}}
