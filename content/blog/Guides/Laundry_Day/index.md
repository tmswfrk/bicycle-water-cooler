...
tags: ["Cycling Clothing", "New Rider Tips"]
keywords: [
    "How to wash cycling clothing", 
    "Taking care of your cycling gear", 
    "cycling clothing in a laundry machine"
]
draft: false
resources:
- src: '*/laundry_basket.jpeg'
  name: "laundrybasket"
  title: "What an exciting subject!"
  params:
    alt: "A few recommendations on how to properly care and maintain your cycling clothing, wash after wash. Image contains: laundry basket, Maap cycling clothing, base layer, bib short."
- src: '*/front_loaders.jpg'
  name: "frontloaders"
  title: "Same ones that I had in my last place, and I certainly miss them!"
  params:
    alt: "Front loading washing machines inside apartment"
    width: 50
    exclude_gps: true
- src: '*/laundry_bags.jpg'
  name: "laundrybags"
  title: "I definitely have gotten my money's worth with these."
  params:
    alt: "Laundry bags used to put cycling clothes into and then into the washer"
    exclude_gps: true
- src: '*/morbo.gif'
  name: "morbo"
  title: "Who doesn't love Morbo?"
  params:
    alt: "Morbo from Futurama saying Doom"
    width: 50
- src: '*/woolite.jpg'
  name: "woolite"
  title: "Is this actually a product review for Woolite?"
  params:
    alt: "Woolite Darks laundry detergent container in laundry basket with cycling clothes"
    exclude_gps: true
- src: '*/eww.gif'
  name: "eww"
  title: "Just don't."
  params:
    alt: "Gif of Michael Scott from The Office saying Eww"
    width: 35
- src: '*/alldone.jpg'
  name: "alldone"
  title: "A lazy way to do this!"
  params:
    alt: "Cycling clothing hanging off the side of a laundry basket"
    exclude_gps: true
- src: '*/tatters.jpg'
  name: "tatters"
  title: "Just don't."
  params:
    alt: "Tattered shirt stock image"
    width: 50
    exclude_gps: true
---
